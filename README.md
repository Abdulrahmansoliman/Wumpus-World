...
Hybrid architecture: Python simulator + Prolog knowledge base (via SWI-Prolog) + optional Tkinter GUI.
...
python gui.py  # Tkinter GUI (agent or human play)
```
...
- `gui.py` - Tkinter GUI with config controls and live board rendering
